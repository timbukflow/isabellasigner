...
<body>
     <section class="datenschutz">
        ...
        <p>5.1 Datenschutzrechtliche Ansprüche</p>
        <p>
        ...
        <p>
            Wir nutzen insbesondere: <br>
            <a href="https://www.hostpoint.ch/hostpoint/kontakt-agb.html#datenschutz">Dienste von Hostpoint AG</a><br>
            <a href="https://docs.github.com/de/site-policy/privacy-policies/github-privacy-statement">Dienste von GitHub</a><br>
        </p>
        <p>8.2 Schriftarten</p>
        <p>
        ...
        <p>
            Wir nutzen insbesondere: <br>
            <a href="https://fonts.google.com/">Dienste von Google Fonts</a><br>
        </p>

        <h2>9. Erweiterungen für die Website</h2>
        <p>
            Wir verwenden Erweiterungen für unsere Website, um zusätzliche Funktionen nutzen zu können.
        </p>
        <p>
            Wir nutzen insbesondere: <br>
            <a href="https://jquery.com/">Dienste von jQuery (OpenJS Foundation)</a><br>
        </p>
        
        <h2>10. Erfolgs- und Reichweitenmessung</h2>
        <p>
